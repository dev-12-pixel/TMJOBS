...
export default function Micro1Page() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const totalEmailed = clientReferrals.length;
      ...
      <div className="space-y-6 animate-fade-in">
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-500">Specialized Tech Staffing</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <MetricCard
            ...
            subtitle={`${formatPercentage(metrics?.appliedToHiredRatio || 0)} conversion`}
          />
          <MetricCard
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card title="Hiring Conversion Funnel">
            <div className="space-y-3">
              {[
                { label: 'Applied', count: metrics?.totalReferrals || 0, pct: 100, color: '#6366f1' },
